...
class Computadora:
    ...
    def __init__(self, marca:str, capacidad:int, ram:int):
        print(f"Accediendo al cosntructor de la pc: {marca}")
        self.marca = marca
        self.capacidad = capacidad
        self.ram = ram

    def imprimirInfoPC(self):
        print(f"Esta es la comptadora marca: {self.marca} con almacenamiento de {self.capacidad}GB y memoria de {self.ram}GB")
...
class Persona:
    ...
    #========================
    def __init__(self, nombres:str, apellidos:str, edad:int, direccion:int, marca:str, capacidad:int, ram:int):
