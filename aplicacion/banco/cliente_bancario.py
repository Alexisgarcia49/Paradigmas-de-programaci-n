...
class ClienteBancario:
    ...
    # Si la edad es menos que 18 genera un error
    #=============================================
    ...
    #=====================================================
    # Método pribado que checa si el balance es negativo
    # y genera un error
    #=====================================================

    def __validarCantidad(self, balanceDeCuenta: float) -> None:
        if balanceDeCuenta < 0:
            raise Exception("El balance en la cuenta no puede serr negativo")

    def gaurdarDinero(self, cantidad:float) -> None:
    ...
    def retirarDinero(self, cantidad:float) -> None:
        ...
        self.__mandarEmail("----reirando dinero----", " se retiró "+ str(cantidad))
        self.__enviarBalanceAlBanco(cantidad)
